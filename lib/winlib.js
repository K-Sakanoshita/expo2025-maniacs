        ...
        return new Promise((resolve, reject) => {
            ...
            if (!isWide) {  // 縦長画面の場合
                ...
                switch (this.sidebarSize) {
                    ...
                    case 1: mapsize = Math.max(maxHeight / 6, Conf.minimap.height); break;
                    case 2: mapsize = maxHeight - (btmPane.clientHeight); break;
                }
                ...
                const icon = this.sidebarSize == 1 ? "left" : "right"
                sideChg.innerHTML = `<i class='fa-solid fa-chevron-${icon}'></i>`
                ...
                switch (this.sidebarSize) {
                    ...
                    case 1: btmWidth = 480; break;
                    case 2: btmWidth = maxWidth; break;
                }

                topWidth = maxWidth - btmWidth;
                minimap.style.height = (document.getElementById("bottom-pane").clientHeight * 0.7) + "px"

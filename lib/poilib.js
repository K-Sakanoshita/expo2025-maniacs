...
class PoiCont {
                    ...
                    layout: {
                        ...
                        "text-font": Conf.icon.textFont, "text-size":
                            [
                                ...
                                16, Conf.icon.textSize * 0.8,
                                17, Conf.icon.textSize * 1.0,
                                18, Conf.icon.textSize * 1.2,
    ...
    select(poiid, detail, zoomOffset = 0) {					// Map move to PoiId & Zoom(config)
        return new Promise((resolve, reject) => {
            let zoomlv = Math.max(mapLibre.getZoom(true), Conf.map.modalZoom) + zoomOffset
